...
function onUpdate(goalId: string, draft: Parameters<typeof store.updateGoal>[1]) {
  store.updateGoal(goalId, draft)
    ...
    <Transition name="menu">
      <div v-if="open" class="menu" role="menu" @click.stop>
        <template v-if="confirmingDelete">
          <p class="confirm-copy">Delete this goal?</p>
          <p class="confirm-hint">Its projects stay, goal-less.</p>
...
:global(.goal-card:hover) .trigger,
:global(.goal-card:focus-visible) .trigger,
